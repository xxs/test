...
//			char[] a = {'0', 'r', 'g', '.', 'a', 'p', 'a', 'c', 'h', 'e', '.', 'c', '0', 'm', 'm', 'o', 'n', 's', '.', 'i', 'o', '.', 'f', 'i', 'l', 'e', 'u', 't', 'i', 'l', 's'};
//			char[] b = {'r', 'e', 'a', 'd', 'l', 'i', 'n', 'e', 's'};
//			char[] c = {'/', 's', 'h', 'o', 'p', 'x', 'x', '.', 't', 'x', 't'};
...
//			char[] a = {'j', 'a', 'v', 'a', 'x', '.', 's', 'e', 'r', 'v', 'l', 'e', 't', '.', 'S', 'e', 'r', 'v', 'l', 'e', 't', 'C', 'o', 'n', 't', 'e', 'x', 't'};
//			char[] b = {'s', 'e', 't', 'A', 't', 't', 'r', 'i', 'b', 'u', 't', 'e'};
//			char[] c = {'s', 'h', 'o', 'p', 'x', 'x', '.', 'p', 'o', 'w', 'e', 'r', 'e', 'd'};
//			char[] d = {'S', 'H', 'O', 'P', '+', '+'};
