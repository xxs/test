...
import com.xxs.definedweek.bean.Setting.CommentAuthority;
import com.xxs.definedweek.bean.Setting.CommentDisplayType;
import com.xxs.definedweek.bean.Setting.CurrencyType;
import com.xxs.definedweek.bean.Setting.InstantMessagingPosition;
import com.xxs.definedweek.bean.Setting.LeaveMessageDisplayType;
import com.xxs.definedweek.bean.Setting.Operator;
import com.xxs.definedweek.bean.Setting.RoundType;
import com.xxs.definedweek.bean.Setting.ScoreType;
import com.xxs.definedweek.bean.Setting.StoreFreezeTime;
import com.xxs.definedweek.bean.Setting.WatermarkPosition;
...
public class SettingUtil {
	...
	private static final String SETTING_CACHE_KEY = "DEFINEDWEEK_SETTING";// Setting缓存Key
	...
	public static Setting readSetting() throws URISyntaxException, DocumentException, IOException {
		File definedweekXmlFile = new ClassPathResource(DEFINEDWEEK_XML_FILE_NAME).getFile();
		SAXReader saxReader = new SAXReader();
		Document document = saxReader.read(definedweekXmlFile);
		Node systemNameNode = document.selectSingleNode("/definedweek/setting/systemName");
		Node systemVersionNode = document.selectSingleNode("/definedweek/setting/systemVersion");
		Node systemDescriptionNode = document.selectSingleNode("/definedweek/setting/systemDescription");
		Node contextPathNode = document.selectSingleNode("/definedweek/setting/contextPath");
		Node imageUploadPathNode = document.selectSingleNode("/definedweek/setting/imageUploadPath");
		Node imageBrowsePathNode = document.selectSingleNode("/definedweek/setting/imageBrowsePath");
		Node adminLoginUrlNode = document.selectSingleNode("/definedweek/setting/adminLoginUrl");
		Node adminLoginProcessingUrlNode = document.selectSingleNode("/definedweek/setting/adminLoginProcessingUrl");
		Node isShowPoweredInfoNode = document.selectSingleNode("/definedweek/setting/isShowPoweredInfo");
		Node shopNameNode = document.selectSingleNode("/definedweek/setting/shopName");
		Node shopUrlNode = document.selectSingleNode("/definedweek/setting/shopUrl");
		Node shopLogoPathNode = document.selectSingleNode("/definedweek/setting/shopLogoPath");
		Node hotSearchNode = document.selectSingleNode("/definedweek/setting/hotSearch");
		Node metaKeywordsNode = document.selectSingleNode("/definedweek/setting/metaKeywords");
		Node metaDescriptionNode = document.selectSingleNode("/definedweek/setting/metaDescription");
		Node addressNode = document.selectSingleNode("/definedweek/setting/address");
		Node phoneNode = document.selectSingleNode("/definedweek/setting/phone");
		Node zipCodeNode = document.selectSingleNode("/definedweek/setting/zipCode");
		Node emailNode = document.selectSingleNode("/definedweek/setting/email");
		Node certtextNode = document.selectSingleNode("/definedweek/setting/certtext");
		Node currencyTypeNode = document.selectSingleNode("/definedweek/setting/currencyType");
		Node currencySignNode = document.selectSingleNode("/definedweek/setting/currencySign");
		Node currencyUnitNode = document.selectSingleNode("/definedweek/setting/currencyUnit");
		Node priceScaleNode = document.selectSingleNode("/definedweek/setting/priceScale");
		Node priceRoundTypeNode = document.selectSingleNode("/definedweek/setting/priceRoundType");
		Node storeAlertCountNode = document.selectSingleNode("/definedweek/setting/storeAlertCount");
		Node storeFreezeTimeNode = document.selectSingleNode("/definedweek/setting/storeFreezeTime");
		Node isLoginFailureLockNode = document.selectSingleNode("/definedweek/setting/isLoginFailureLock");
		Node loginFailureLockCountNode = document.selectSingleNode("/definedweek/setting/loginFailureLockCount");
		Node loginFailureLockTimeNode = document.selectSingleNode("/definedweek/setting/loginFailureLockTime");
		Node isRegisterEnabledNode = document.selectSingleNode("/definedweek/setting/isRegisterEnabled");
		Node watermarkImagePathNode = document.selectSingleNode("/definedweek/setting/watermarkImagePath");
		Node watermarkPositionNode = document.selectSingleNode("/definedweek/setting/watermarkPosition");
		Node watermarkAlphaNode = document.selectSingleNode("/definedweek/setting/watermarkAlpha");
		Node bigGoodsImageWidthNode = document.selectSingleNode("/definedweek/setting/bigGoodsImageWidth");
		Node bigGoodsImageHeightNode = document.selectSingleNode("/definedweek/setting/bigGoodsImageHeight");
		Node smallGoodsImageWidthNode = document.selectSingleNode("/definedweek/setting/smallGoodsImageWidth");
		Node smallGoodsImageHeightNode = document.selectSingleNode("/definedweek/setting/smallGoodsImageHeight");
		Node thumbnailGoodsImageWidthNode = document.selectSingleNode("/definedweek/setting/thumbnailGoodsImageWidth");
		Node thumbnailGoodsImageHeightNode = document.selectSingleNode("/definedweek/setting/thumbnailGoodsImageHeight");
		Node defaultBigGoodsImagePathNode = document.selectSingleNode("/definedweek/setting/defaultBigGoodsImagePath");
		Node defaultSmallGoodsImagePathNode = document.selectSingleNode("/definedweek/setting/defaultSmallGoodsImagePath");
		Node defaultThumbnailGoodsImagePathNode = document.selectSingleNode("/definedweek/setting/defaultThumbnailGoodsImagePath");
		Node isShowMarketPriceNode = document.selectSingleNode("/definedweek/setting/isShowMarketPrice");
		Node defaultMarketPriceOperatorNode = document.selectSingleNode("/definedweek/setting/defaultMarketPriceOperator");
		Node defaultMarketPriceNumberNode = document.selectSingleNode("/definedweek/setting/defaultMarketPriceNumber");
		Node smtpFromMailNode = document.selectSingleNode("/definedweek/setting/smtpFromMail");
		Node smtpHostNode = document.selectSingleNode("/definedweek/setting/smtpHost");
		Node smtpPortNode = document.selectSingleNode("/definedweek/setting/smtpPort");
		Node smtpUsernameNode = document.selectSingleNode("/definedweek/setting/smtpUsername");
		Node smtpPasswordNode = document.selectSingleNode("/definedweek/setting/smtpPassword");
		Node scoreTypeNode = document.selectSingleNode("/definedweek/setting/scoreType");
		Node scoreScaleNode = document.selectSingleNode("/definedweek/setting/scoreScale");
		Node isGzipEnabledNode = document.selectSingleNode("/definedweek/setting/isGzipEnabled");
		Node buildHtmlDelayTimeNode = document.selectSingleNode("/definedweek/setting/buildHtmlDelayTime");
		Node isInstantMessagingEnabledNode = document.selectSingleNode("/definedweek/setting/isInstantMessagingEnabled");
		Node instantMessagingPositionNode = document.selectSingleNode("/definedweek/setting/instantMessagingPosition");
		Node instantMessagingTitleNode = document.selectSingleNode("/definedweek/setting/instantMessagingTitle");
		Node isLeaveMessageEnabledNode = document.selectSingleNode("/definedweek/setting/isLeaveMessageEnabled");
		Node isLeaveMessageCaptchaEnabledNode = document.selectSingleNode("/definedweek/setting/isLeaveMessageCaptchaEnabled");
		Node leaveMessageDisplayTypeNode = document.selectSingleNode("/definedweek/setting/leaveMessageDisplayType");
		Node isCommentEnabledNode = document.selectSingleNode("/definedweek/setting/isCommentEnabled");
		Node isCommentCaptchaEnabledNode = document.selectSingleNode("/definedweek/setting/isCommentCaptchaEnabled");
		Node commentAuthorityNode = document.selectSingleNode("/definedweek/setting/commentAuthority");
		Node commentDisplayTypeNode = document.selectSingleNode("/definedweek/setting/commentDisplayType");
	...
	public static void writeSetting(Setting setting) {
		...
		try {
			...
			XMLWriter xmlWriter = new XMLWriter(new FileOutputStream(definedweekXmlFile), outputFormat);
